...
@OAuth2(configElementName = "oauth2", friendlyName = "OAuth 2.0", authorizationUrl = "http://localhost:9091/oauth/authorize", accessTokenUrl = "http://localhost:9091/oauth/accessToken")
